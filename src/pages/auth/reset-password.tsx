    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await resetPassword({
                ...
                onError: (ctx: any) => setError(ctx.error.message || 'Failed to reset password. Please try again.'),
            });
        } catch (err: any) {
                ...
                <div className="hidden lg:flex w-1/2 relative overflow-hidden bg-red-700">
                    ...
                    <div className="relative z-10 w-full h-full flex flex-col items-center justify-center p-12 text-center text-white space-y-8">
                        ...
                        <div className="space-y-4 max-w-lg">
                            <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-white drop-shadow-sm">New Password</h2>
